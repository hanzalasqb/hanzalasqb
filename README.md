...
- ☁️ **Cloud Native Applications & AWS Infrastructure**
- 🤖 **AI-Assisted Development & LLM Integration**
- 🔒 **Secure API Authentication & Web Security**
...
| :--- | :--- | :--- | :--- |
| **AI Engineering Copilot** | An AI-powered engineering assistant and collaboration platform with intelligent file analysis. | React, Node.js, tRPC, Drizzle | [View Repo](https://github.com/hanzalasqb/ai-engineering-copilot) |
| **HS Space Dashboard** | Professional full-stack project management and space-themed IoT dashboard. | React, TypeScript, tRPC | [View Repo](https://github.com/hanzalasqb/hs-space) |
| **By Salma Commerce** | A modern full-stack e-commerce and business management platform with integrated auth. | React, Node.js, MySQL, Drizzle | [View Repo](https://github.com/hanzalasqb/by-salma) |
...
| **Spotify UI Clone** | Feature-rich music streaming interface with interactive playlists and audio player. | JavaScript, HTML, CSS | [View Repo](https://github.com/hanzalasqb/Spotify-Clone-UI) |
